/**********************************************************************************
 * $URL: https://source.etudes.org/svn/serenity/trunk/chat/chat-webapp/src/main/java/org/etudes/chat/webapp/ChatCdpHandler.java $
 * $Id: ChatCdpHandler.java 10431 2015-04-06 19:16:59Z ggolden $
 ***********************************************************************************
 *
...
/**
 */
public class ChatCdpHandler implements CdpHandler
{
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(ChatCdpHandler.class);
	...
	/**
	 * @return The registered ChatService.
	 */
	private ChatService chatService()
	{
		return (ChatService) Services.get(ChatService.class);
	}
