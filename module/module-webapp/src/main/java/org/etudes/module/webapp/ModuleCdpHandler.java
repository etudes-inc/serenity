/**********************************************************************************
 * $URL: https://source.etudes.org/svn/serenity/trunk/module/module-webapp/src/main/java/org/etudes/module/webapp/ModuleCdpHandler.java $
 * $Id: ModuleCdpHandler.java 10431 2015-04-06 19:16:59Z ggolden $
 ***********************************************************************************
 *
...
/**
 */
public class ModuleCdpHandler implements CdpHandler
{
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(ModuleCdpHandler.class);
	...
	/**
	 * @return The registered ModuleService.
	 */
	private ModuleService moduleService()
	{
		return (ModuleService) Services.get(ModuleService.class);
	}
